...
Claude Code generates the script and updates settings automatically. For full control, read on.
...
<Callout variant="warning">
  **Rate limits not available.** Hourly usage limits aren't exposed to statusline scripts. [Feature request](https://github.com/anthropics/claude-code/issues/18121).
</Callout>
...
<Callout variant="tip">
  To remove: run `/statusline delete` or remove the `statusLine` field from `settings.json`.
</Callout>
