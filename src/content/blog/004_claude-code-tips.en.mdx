...
## 2. sonnet[1m] — 1 Million Token Context
...
## 3. Agent Teams — Multiple Claudes Working Together
...
## 4. Fast Mode — Same Quality, Lower Latency
...
## 5. Effort Levels — Control How Hard Claude Thinks
